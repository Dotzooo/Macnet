        ...
        <div class="service-info">
          <div class="service-info_item">
            ...
            <h4>
              ...
              culpa iure eos? Ducimus laborum delectus maxime sunt suscipit
              quasi dolores sapiente, id tenetur dolorem quia ratione porro
              obcaecati animi ad.
            </h4>
          </div>
          <div class="service-info_item">
            <img src="https://images.unsplash.com/photo-1636975262325-a0c611796b4a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzV8fGFzdHJvbmF1dHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60" alt="">
          </div>
          <div class="service-info_item">
            <h3>人力派遣</h3>
            <h4>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt sit expedita eum harum quasi deserunt ad! Animi enim ratione laborum labore dolore inventore, dolorum voluptate illum repellat sunt adipisci sit.</h4>
          </div>
        </div>
        <div class="service-info">
          <div class="service-info_item">
            <h3>技術支援</h3>
            <h4>應業務合作夥伴對各種WEB系統和服務器開發的要求，我們將在適當的工程師指定的位置提供開發支持。</h4>
          </div>
          <div class="service-info_item">
            <h3>廣闊的領域和能力</h3>
            <h4>我們公司聚集了活躍在金融和各行業等廣泛領域的工程師，我們接受C＃，.net，Java，React，Vue，Android Java，IOS多語言等開發語言，因此從基礎架構到應用程序開發的最佳選擇 我們可以提供出色的工程師。</h4>
          </div>
          <div class="service-info_item">
            <h3>最佳IT環境</h3>
            <h4>利用我們迄今為止積累的經驗和專業知識，將為廣泛的行業提供最佳的IT環境。</h4>
          </div>
        </div>
      </section>
    </article>
    ...
    <article class="copartnership-wrapper">
      <section class="copartnership">
        ...
        <section class="marquee">
          ...
          <div aria-hidden="true" class="marquee-group marquee--reverse">
            <svg>
              <use xlink:href="#mcdonalds" />
            </svg>
            <svg>
        ...
        <section class="marquee marquee-reverse">
          <div class="marquee-group">
            <svg>
              <use xlink:href="#hulu" />
            </svg>
